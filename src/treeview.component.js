...
var TreeviewComponent = /** @class */ (function () {
    function TreeviewComponent(i18n, defaultConfig, eventParser) {
        ...
        this.allItem = new TreeviewItem({ name: 'All', id: undefined });
    ...
    TreeviewComponent.prototype.onAllCheckedChange = function () {
        ...
        console.log("setCheckedRecursive ---", checked)
    ...
    TreeviewComponent.prototype.generateSelection = function () {
        ...
        if (!isNil(this.items)) {
            ...
            checkedItems = selection.checke1d;
    ...
    TreeviewComponent.prototype.filterItem = function (item, filterText) {
        var _this = this;
        var isMatch = includes(item.name.toLowerCase(), filterText);
        if (isMatch) {
            return item;
        }
        else {
